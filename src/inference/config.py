...
SCALING_FACTOR = {}
SCALING_FACTOR['MAX_COMPUTE_UTIL'] = 0.85
SCALING_FACTOR['MAX_OFF_MEM_BW_UTIL'] = 0.81
...
def make_pim_config(pim_type: PIMType,
    ...
    config[
        "MEM_BW_PER_HBM"] = 650.4 * 1000 * 1000 * 1000 * internal_bandwidth_scale
    ...
    config["RES_ATTENTION_TABLE"] = os.path.join(table_path, "@attacc-attn_inference.csv")
    config["RES_GEMV_TABLE"] = os.path.join(table_path, "@attacc-gemv_inference.csv")
