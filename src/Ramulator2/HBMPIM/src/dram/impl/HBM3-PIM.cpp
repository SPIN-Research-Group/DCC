...
class HBM3PIM : public IDRAM, public Implementation {
   ...
   ***********************************************/
    inline static constexpr ImplDef m_commands = {
      ...
      "MACAB", "MACSB", "MACPB",
      "WRGB", "MVSB", "MVGB", "SFM",
      "SETM", "SETH", "BARRIER", "DUMMY",
      "LD_OP1", "LD_OP2", "LD_OP3",
      "MUL_OP1", "MUL_OP2", "MUL_OP3",
      "ADD_OP1", "ADD_OP2", "ADD_OP3",
      "MAC_OP1", "MAC_OP2", "MAC_OP3",
      "WB_ACC", "WB_RES", "ACC_RESET", "RELU"
    };
    ...
    inline static const ImplLUT m_command_meta = LUT<DRAMCommandMeta> (
      m_commands, {
        ...
        {"LD_OP1", {false,  false,   true,   false}},
        {"LD_OP2", {false,  false,   true,   false}},
        {"LD_OP3", {false,  false,   true,   false}},
        {"MUL_OP1", {false,  false,   true,   false}},
        {"MUL_OP2", {false,  false,   true,   false}},
        {"MUL_OP3", {false,  false,   true,   false}},
        {"ADD_OP1", {false,  false,   true,   false}},
        {"ADD_OP2", {false,  false,   true,   false}},
        {"ADD_OP3", {false,  false,   true,   false}},
        {"MAC_OP1", {false,  false,   true,   false}},
        {"MAC_OP2", {false,  false,   true,   false}},
        {"MAC_OP3", {false,  false,   true,   false}},
        {"WB_ACC", {false,  false,   true,   false}},
        {"WB_RES", {false,  false,   true,   false}},
        {"ACC_RESET", {false,  false,   false,   false}},
    ...
    inline static constexpr ImplDef m_requests = {
      ...
      "pim-softmax", "pim-set-model", "pim-set-head", "pim-barrier", "pim-dummy",
      "pim-ld-op1", "pim-ld-op2", "pim-ld-op3", "pim-mul-op1", "pim-mul-op2", "pim-mul-op3",
      "pim-add-op1", "pim-add-op2", "pim-add-op3", "pim-mac-op1", "pim-mac-op2", "pim-mac-op3",
      "pim-wb-acc", "pim-wb-res", "pim-acc-reset", "pim-relu"
    };
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      populate_timingcons(this, {
          ...
          /// Data bus occupancy
          {.level = "pseudochannel", .preceding = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .following = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .latency = V("nBL")},
          /// Minimal latency to different bank group for commands regarding data path
          {.level = "rank", .preceding = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .following = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .latency = V("nCCDS")},
          /// Minimal latency to same bank group for column commands regarding data path
          {.level = "bankgroup", .preceding = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .following = {"WRGB", "MVSB", "MVGB", "SFM", "RD", "WR", "DUMMY"}, .latency = V("nCCDL")},
          

          /*** Custom PIM Operations (Unified serialization across all operations) ***/
          /// All custom operations share row buffer access and must serialize
          /// Channel level: Data bus occupancy
          {.level = "channel", 
           .preceding = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3", 
                         "MUL_OP1", "MUL_OP2", "MUL_OP3", "MAC_OP1", "MAC_OP2", "MAC_OP3"}, 
           .following = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3",
                         "MUL_OP1", "MUL_OP2", "MUL_OP3", "MAC_OP1", "MAC_OP2", "MAC_OP3"}, 
           .latency = V("nBL")},
          /// Rank level: Minimal latency between different bankgroups
          {.level = "rank", 
           .preceding = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3", 
                         "MUL_OP1", "MUL_OP2", "MUL_OP3", "MAC_OP1", "MAC_OP2", "MAC_OP3"}, 
           .following = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3",
                         "MUL_OP1", "MUL_OP2", "MUL_OP3", "MAC_OP1", "MAC_OP2", "MAC_OP3"}, 
           .latency = V("nCCDS")},
          /// Bankgroup level: Minimal latency within same bankgroup
          {.level = "bankgroup", 
           .preceding = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3", 
                         "MUL_OP1", "MUL_OP2", "MUL_OP3", "MAC_OP1", "MAC_OP2", "MAC_OP3"}, 
           .following = {"LD_OP1", "LD_OP2", "LD_OP3", "ADD_OP1", "ADD_OP2", "ADD_OP3",
    ...
    void set_preqs() {
      ...
      // All-bank PIM operations
      m_preqs[m_levels["bank"]][m_commands["LD_OP1"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["LD_OP2"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["LD_OP3"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MUL_OP1"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MUL_OP2"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MUL_OP3"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["ADD_OP1"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["ADD_OP2"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["ADD_OP3"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MAC_OP1"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MAC_OP2"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
      m_preqs[m_levels["bank"]][m_commands["MAC_OP3"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;

      m_preqs[m_levels["bank"]][m_commands["WB_ACC"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;

      m_preqs[m_levels["bank"]][m_commands["WB_RES"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;

      m_preqs[m_levels["bank"]][m_commands["RELU"]] = Lambdas::Preq::Bank::RequireAllBanksRowOpen<HBM3PIM>;
    };
    ...
    void set_rowhits() {
      ...
      // Custom PIM operations
      m_rowhits[m_levels["bank"]][m_commands["LD_OP1"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["LD_OP2"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["LD_OP3"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MUL_OP1"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MUL_OP2"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MUL_OP3"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["ADD_OP1"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["ADD_OP2"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["ADD_OP3"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MAC_OP1"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MAC_OP2"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["MAC_OP3"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["WB_ACC"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
      m_rowhits[m_levels["bank"]][m_commands["WB_RES"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;

      m_rowhits[m_levels["bank"]][m_commands["RELU"]] = Lambdas::RowHit::Bank::RDWR<HBM3PIM>;
    }
    ...
    void set_rowopens() {
      ...
      // Custom PIM operations
      m_rowopens[m_levels["bank"]][m_commands["LD_OP1"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["LD_OP2"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["LD_OP3"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MUL_OP1"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MUL_OP2"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MUL_OP3"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["ADD_OP1"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["ADD_OP2"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["ADD_OP3"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MAC_OP1"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MAC_OP2"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["MAC_OP3"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["WB_ACC"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
      m_rowopens[m_levels["bank"]][m_commands["WB_RES"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;

      m_rowopens[m_levels["bank"]][m_commands["RELU"]] = Lambdas::RowOpen::Bank::RDWR<HBM3PIM>;
    }
