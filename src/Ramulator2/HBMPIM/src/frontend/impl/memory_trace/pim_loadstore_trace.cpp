    ...
    void tick() override {
      ...
      while(!req_full && !is_finished()) {
        ...
        switch (t.req_type) {
          ...
          case 14: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_DUMMY}); break;
          case 15: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_LD_OP1}); break;
          case 16: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_LD_OP2}); break;
          case 17: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_LD_OP3}); break;
          case 18: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_ADD_OP1}); break;
          case 19: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_ADD_OP2}); break;
          case 20: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_ADD_OP3}); break;
          case 21: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MUL_OP1}); break;
          case 22: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MUL_OP2}); break;
          case 23: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MUL_OP3}); break;
          case 24: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MAC_OP1}); break;
          case 25: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MAC_OP2}); break;
          case 26: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_MAC_OP3}); break;
          case 27: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_WB_ACC}); break;
          case 28: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_WB_RES}); break;
          case 29: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_ACC_RESET}); break;
          case 30: request_sent = m_memory_system->send({t.addr, Request::Type::PIM_RELU}); break;
          default:;
        }
        if (request_sent) {
    ...
    void init_trace(const std::string& file_path_str) {
      ...
      while (std::getline(trace_file, line)) {
        ...
        if (tokens[0] == "LD") {
          ...
          req_type = 13;
        } else if (tokens[0] == "PIM_DUMMY") {
          req_type = 14;
        } else if (tokens[0] == "PIM_LD_OP1") {
          req_type = 15;
        } else if (tokens[0] == "PIM_LD_OP2") {
          req_type = 16;
        } else if (tokens[0] == "PIM_LD_OP3") {
          req_type = 17;
        } else if (tokens[0] == "PIM_ADD_OP1") {
          req_type = 18;
        } else if (tokens[0] == "PIM_ADD_OP2") {
          req_type = 19;
        } else if (tokens[0] == "PIM_ADD_OP3") {
          req_type = 20;
        } else if (tokens[0] == "PIM_MUL_OP1") {
          req_type = 21;
        } else if (tokens[0] == "PIM_MUL_OP2") {
          req_type = 22;
        } else if (tokens[0] == "PIM_MUL_OP3") {
          req_type = 23;
        } else if (tokens[0] == "PIM_MAC_OP1") {
          req_type = 24;
        } else if (tokens[0] == "PIM_MAC_OP2") {
          req_type = 25;
        } else if (tokens[0] == "PIM_MAC_OP3") {
          req_type = 26;
        } else if (tokens[0] == "PIM_WB_ACC") {
          req_type = 27;
        } else if (tokens[0] == "PIM_WB_RES") {
          req_type = 28;
        } else if (tokens[0] == "PIM_ACC_RESET") {
          req_type = 29;
        } else if (tokens[0] == "PIM_RELU") {
          req_type = 30;
        } else {
          throw ConfigurationError("Trace {} format invalid!", file_path_str);
        }
