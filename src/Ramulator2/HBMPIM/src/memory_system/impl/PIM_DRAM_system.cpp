...
class PIMDRAMSystem final : public IMemorySystem, public Implementation {
  ...
  public:
    ...
    int s_num_pim_dummy_requests = 0;
    int s_num_pim_ldop_requests = 0;
    int s_num_pim_add_requests = 0;
    int s_num_pim_mul_requests = 0;
    int s_num_mac_requests = 0;
  ...
  public:
    void init() override { 
      ...
      register_stat(s_num_pim_dummy_requests).name("total_num_pim_dummy_requests");
      register_stat(s_num_pim_ldop_requests).name("total_num_pim_ldop_requests");
      register_stat(s_num_pim_add_requests).name("total_num_pim_add_requests");
      register_stat(s_num_pim_mul_requests).name("total_num_pim_mul_requests");
      register_stat(s_num_mac_requests).name("total_num_mac_requests");
    ...
    bool send(Request req) override {
      ...
      if (is_success) {
        switch (req.type_id) {
          ...
          case Request::Type::PIM_DUMMY: {
            s_num_pim_dummy_requests++;
            break;
          }
          case Request::Type::PIM_LD_OP1: {
            s_num_pim_ldop_requests++;
            break;
          }
          case Request::Type::PIM_LD_OP2: {
            s_num_pim_ldop_requests++;
            break;
          }
          case Request::Type::PIM_LD_OP3: {
            s_num_pim_ldop_requests++;
            break;
          }
          case Request::Type::PIM_ADD_OP1: {
            s_num_pim_add_requests++;
            break;
          }
          case Request::Type::PIM_ADD_OP2: {
            s_num_pim_add_requests++;
            break;
          }
          case Request::Type::PIM_ADD_OP3: {
            s_num_pim_add_requests++;
            break;
          }
          case Request::Type::PIM_MUL_OP1: {
            s_num_pim_mul_requests++;
            break;
          }
          case Request::Type::PIM_MUL_OP2: {
            s_num_pim_mul_requests++;
            break;
          }
          case Request::Type::PIM_MUL_OP3: {
            s_num_pim_mul_requests++;
            break;
          }
          case Request::Type::PIM_MAC_OP1: {
            s_num_mac_requests++;
            break;
          }
          case Request::Type::PIM_MAC_OP2: {
            s_num_mac_requests++;
            break;
          }
          case Request::Type::PIM_MAC_OP3: {
            s_num_mac_requests++;
            break;
          }
          default: {
